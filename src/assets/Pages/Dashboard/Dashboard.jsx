...
import { FaBloggerB, FaCodeBranch, FaDonate, FaHome, FaUsers } from "react-icons/fa";
    ...
    return (
        <div className="flex">
            <div className="h-full p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
                ...
                <Link to={'my-donation-request'}> <li className="dark:bg-gray-800 dark:text-gray-50">
                   <div className="flex items-center p-2 space-x-3 rounded-md">
                    <FaCodeBranch></FaCodeBranch>
               ...
               <Link to={"create-donation-request"}> <li>
                <div className="flex items-center p-2 space-x-3 rounded-md">
                    <FaDonate></FaDonate>
                        <span>Create Donation Request Page</span>
                    </div>
                </li></Link>
